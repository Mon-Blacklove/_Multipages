    ...
    return(
        <div className="timer-container">
            ...
            <div className='timer-buttons'>
                <button className='badge btn btn-danger' onClick={resetClick}>Reset</button>
                <button className={'badge btn ' + (running ? 'btn-warning' : 'btn-success')} onClick={runClick}>{running ? 'Pause' : 'Run'}</button>
            </div>
        </div>
